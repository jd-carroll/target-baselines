...
//
	...
	/**
	 * Creates and returns a new push button with the given
	 * label and/or alignment.
	 * 
	 * @param parent parent control
	 * @param label button label or <code>null</code>
	 * @param alignment the alignment for the new button
	 * @return a new push button
	 */
	public static Button createPushButton(Composite parent, String label, int alignment) {
	...
	/**
	 * Creates and returns a new push button with the given
	 * label and/or image and/or alignment.
	 * 
	 * @param parent parent control
	 * @param label button label or <code>null</code>
	 * @param image image of <code>null</code>
	 ...
	 * @return a new push button
	 */
	public static Button createPushButton(Composite parent, String label, Image image, int alignment) {
		Button button = createPushButton(parent, label);
		button.setAlignment(alignment);
		if (image != null) {
			button.setImage(image);
...
//	
	...
	public static Label createLabel(Composite parent, String text) {
		Label l = createLabel(parent, SWT.NONE);
		if (text != null) {
			l.setText(text);
		}
		return l;
	 ...
	 * 
	 * @param parent the parent composite to add this label widget to
	 * @param style the style for the label
	 * @return the new label
	 */
	public static Label createLabel(Composite parent, int style) {
		Label l = new Label(parent, SWT.NONE | style);
	...
	public static Label createLabel(Composite parent, int style, String text) {
		Label l = createLabel(parent, style);
		if (text != null) {
			l.setText(text);
		}
		return l;
...
//	
	/**
	 * Creates a composite that uses the parent's font
	 * 
	 * @param parent the parent to add the composite to
	...
	public static Composite createComposite(Composite parent, int style) {
		Composite comp = new Composite(parent, SWT.NONE | style);
